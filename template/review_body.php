...
{
  $my_comment = isset($user_id) && $user_id == $review['author_id']; ?>
  <div class="<?php echo $my_comment ? "my-comment" : "user-comment"; ?>" id="<?php echo $review['id']; ?>">
    ...
    <div class="comment-control">
      <button class="vote upvote<?php if ($review['vote'] == 1) echo " active"; ?>">
        <i class="fas fa-caret-up"></i>
      </button>
      <span class="votenum"><?php echo $review['num_votes']; ?></span>
      <button class="vote downvote<?php if ($review['vote'] == -1) echo " active"; ?>">
