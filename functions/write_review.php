<?ph
function write_review($review_db, $author_id, $dish_id, $rating, $content) {
  ...
  if ($exist) {
    ...
    $query = "INSERT INTO $review_db (author_id, dish_id, rating, content) VALUES ($author_id, $dish_id, $rating, $content)";
